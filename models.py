...
class scGCN(Model):
    ...
    def _loss(self):
        ...
        for var in self.layers[0].vars.values():
            self.loss += FLAGS.weight_decay * tf.compat.v1.nn.l2_loss(var)
    ...
    def predict(self):
        return tf.compat.v1.nn.softmax(self.outputs)
=======
from layers import *
from utils import *
...
class scGCN(Model):
    ...
    def predict(self):
        return tf.compat.v1.nn.softmax(self.outputs)
>>>>>>> 2c06949cf150beaa06701b20934a71cee0e686d8:scGCN/models.py
